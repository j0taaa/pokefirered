...
- 🚧 Browser port is now at an early playable prototype: map rendering, keyboard movement, collisions, Route 1 adapter-data loading, encounter-tile-gated wild battles, and runtime tests are in `ts-game/`.
