...
- 🚧 Browser port is now at an early playable prototype: map rendering, keyboard movement, collisions, a shared decomp-backed bag/inventory slice, a wild-battle command slice, and runtime tests are in `ts-game/`.
