...
- 🚧 Browser port is now at an early playable prototype: map rendering, keyboard movement, collisions, Route 1 adapter-data loading, metatile behavior metadata, ledge jumps, connection-edge detection, encounter-tile-gated Route 1 wild battles, and runtime tests are in `ts-game/`.
