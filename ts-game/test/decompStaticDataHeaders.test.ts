...
describe('decomp generated static data headers', () => {
  test('ports src/data/heal_locations.h heal-location table exactly', () => {
  ...
  test('ports src/data/heal_locations.h whiteout center and healer tables exactly', () => {
    const source = readSource('src/data/heal_locations.h');
  ...
  test('ports src/data/region_map/region_map_entry_strings.h strings exactly', () => {
  ...
  test('ports src/data/region_map/region_map_entries.h map-name references exactly', () => {
  ...
  test('ports src/data/region_map/region_map_entries.h coordinates and dimensions exactly', () => {
    const source = readSource('src/data/region_map/region_map_entries.h');
